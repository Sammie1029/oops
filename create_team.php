...
<body>
	...
	<div class="container">
		<div class="row">
			<a href="student_home.php" class="btn btn-success" style="margin:10px;">Home</a>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="col-lg-12 form-group">
				<input type="number" name="leaderno" id="leaderno" placeholder="Roll No" required="required" class="form-control">
			</div>
		</div>
		<div class="row">
			<div class="col-lg-12 form-group">
		...
		<div class="row">
			<div class="col-lg-12 form-group">
				<input type="number" name="rollno.1" id="rollno.1" placeholder="Roll No" required="required" class="form-control">
			</div>
		</div>
		<div class="row">
			<div class="col-lg-12 form-group">
		...
		<div class="row">
			<div class="col-lg-12 form-group">
				<input type="number" name="rollno.2" id="rollno.2" placeholder="Roll No" required="required" class="form-control">
			</div>
		</div>
		<div class="row">
			<div class="col-lg-12 form-group">
